...
```{r,echo=TRUE}   
print(output[1]==1 & output[2]>50 * 365 & output[3]>0)                     #1: Monotonic decrease
print(output[1]>50*365 & output[2]==1 & output[3]<0)                     #2: Monotonic increase
print(output[1]>1 & output[1]<50 *365 & output[2]>50 *365 & output[3]>0)    #3: Convex decrease
print(output[1]>50 *365 & output[2]>1 & output[2]<50 *365 & output[3]<0)    #4: Concave increase
print(output[1]>1 & output[1]<50 *365 & output[1]==1 & output[3]<0)       #5: Convex increase
print(output[1]==1 & output[2]>1 & output[2]<50 *365 & output[3]>0)       #6: Concave decrease
```     
